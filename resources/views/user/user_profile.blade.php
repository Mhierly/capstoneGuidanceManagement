                        ...
                        <div class="d-flex">
                            <section class="w-50">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        @if($student->emergency_contact) {{ $student->emergency_contact }} @else <span class="text-danger">Need to update</span> @endif
                                    </div>
                                </div>
                            </section>
                            <section class="w-50">
        ...
        <div class="modal-body">
            <form id="edit_profile_form" class="row g-3" action="{{ route('student.profile.editor') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-6 me-3">
                    ...
                    <input type="text" class="form-control" id="emergency_contact" name="emergency_contact" value="{{ $student->emergency_contact }}">
                </div>
                {{-- Address --}}
