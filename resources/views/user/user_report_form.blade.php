            ...
            <div class="content">
                <form action="{{ route('user.request.report') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="table-container">
                        <table>
                            <tr>
                                <td>Name: <input required type="text" name="victim_name" id="victim_name"
                                        style="width: 273px;"></td>
                                {{-- <td>Signature: <input type="text" name="victim_signature" id="victim_signature"></td> --}}
                            </tr>
                            <tr>
                                <td>Age: <input required type="number" min="0" max="99" name="victim_age"
                                        id="victim_age" style="width: 285px;"></td>
                                <td>Gender:
                            ...
                            <tr>
                                <td>Parents/Guardian: <input type="text" name="victim_parent_guardian"
                                        id="victim_parent_guardian"></td>
                                {{-- <td>Signature: <input type="text" name="parent_guardian_signature" id="parent_guardian_signature"></td> --}}
                            </tr>
                            <tr>
                                <td>Contact no: <input type="number" min="0" name="victim_parent_contact"
                                        id="victim_parent_contact" style="width: 242px;"></td>
                            </tr>
                            <tr>
                                <td>Class Adviser:
                    ...
                    <div class="table-container">
                        <table>
                            <tr>
                                <td><input hidden readonly value="{{ $student->id }}" type="text"
                                        name="complainant_id" id="complainant_id" style="width: 273px;"></td>
                            </tr>
                            <tr>
                                <td>Name: <input readonly value="{{ $student->firstname . ' ' . $student->lastname }}"
                                        type="text" style="width: 273px;"></td>
                            </tr>
                            <tr>
                                <td>Relation to the Victim: <input required type="text" name="relation_to_victim"
                                        id="relation_to_victim" style="width: 173px;"></td>
                            </tr>
                        </table>
                    </div>
                    <div class="table-title">
                    ...
                    <div class="table-container">
                        <table>
                            <tr>
                                <td>Name: <input required type="text" name="offender_name" id="offender_name"
                                        style="width: 273px;"></td>
                                {{-- <td>Signature: <input type="text" name="offender_signature" id="offender_signature"></td> --}}
                            </tr>
                            <tr>
                                <td>Age: <input required type="number" min="0" max="99"
                                        name="offender_age" id="offender_age" style="width: 285px;"></td>
                                <td>Gender:
                            ...
                            <tr>
                                <td>Parents/Guardian: <input type="text" name="offender_parent_guardian"
                                        id="offender_parent_guardian"></td>
                                {{-- <td>Signature: <input type="text" name="offender_parent_guardian_signature" id="offender_parent_guardian_signature"></td> --}}
                            </tr>
                            <tr>
                                <td>Contact no: <input type="number" min="0" name="offender_parent_contact"
                                        id="offender_parent_contact" style="width: 242px;"></td>
                            </tr>
                            <tr>
                                <td>Class Adviser:
                                    <select name="victim_class_adviser" id="victim_class_adviser" style="width: 215px;">
