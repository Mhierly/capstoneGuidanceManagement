                ...
                <div class="col-md-6">
                    <div class="card mb-4 shadow">
                        <div class="card-header text-white">Number of Cases
                            <i class="fas fa-question-circle float-end text-warning" title="Tracking the number of cases or incidents handled by administrators /counselors."></i>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-6">
                    <div class="card mb-4 shadow">
                        <div class="card-header text-white">Number of Request Forms
                            <i class="fas fa-question-circle float-end text-warning" title="Tracking the number of request forms handled by administrators/ counselors."></i>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-6">
                    <div class="card mb-4 shadow">
                        <div class="card-header text-white">Completed Appointments
                            <i class="fas fa-question-circle float-end text-warning" title="Tracking the completed appointments handled by administrators/ counselors."></i>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-6">
                    <div class="card mb-4 shadow" title="Tracking the user accounts handled by administrator/counselors.">
                        <div class="card-header text-white">User Accounts
                            <i class="fas fa-question-circle float-end text-warning" title="Tracking the user accounts handled by administrator/counselors."></i>
                        </div>
                        <div class="card-body">
