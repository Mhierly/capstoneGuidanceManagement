...
@section('content')
    ...
    <div class="modal fade" id="student_concern_modal" tabindex="-1" aria-labelledby="student_concern_modalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title fs-5" id="student_concern_modalLabel">Student Concern <small
                            id="student_last_update"></small></h5>
                            ...
                            <div class="content">
                                ...
                                <div class="table-container">
                                    <table class="w-100">
                                        ...
                                        <tr>
                                            <td>Contact no: <span id="victim_parent_contact" style="width: 242px;"></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Class Adviser: <span id="victim_class_adviser" style="width: 225px;"></span>
                                            </td>
                                ...
                                <div class="table-container">
                                    <table class="w-100">
                                        ...
                                        <tr>
                                            <td>Contact no: <span id="complainant_contact" style="width: 242px;"></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Relation to the Victim: <span id="relation_to_victim"
                                                    style="width: 173px;"></span></td>
                                        </tr>
                                    </table>
                                </div>
                                <div class="table-title">
                                ...
                                <div class="table-container">
                                    <table class="w-100">
                                        ...
                                        <tr>
                                            <td>Contact no: <span id="offender_parent_contact" style="width: 242px;"></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Class Adviser: <span id="offender_class_adviser"
                                                    style="width: 225px;"></span></td>
                ...
                <div class="modal-body">
                    <form class="row g-3" method="POST" action="{{ route('admin.student.concern.action') }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" id="actiontaken" class="form-control" name="actiontaken"
                                placeholder="Take action on this concern!" required>
                        </div>
                        <div class="col-md-12">
                            <label for="rec">Recommendation:</label>
                            <input type="text" id="rec" class="form-control" name="rec"
                                placeholder="What are the guidance's will recommend in this concern?" required>
                        </div>
            ...
            $(document).on('click', '#download_report_info', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        var url =
                            `{{ route('admin.student.concern.download') }}?id=${id}&_token=${token}`;
