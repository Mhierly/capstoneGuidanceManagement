...
<body>
    <div class="container" id="container">
        ...
        <div class="form-container sign-in-container">
            <form id="loginForm" action="{{ route('login') }}" method="POST" enctype="multipart/form-data">
                ...
                <input id="login_email" type="login_email"
                    class="form-control @error('login_email') is-invalid @enderror" name="login_email"
                    value="{{ old('login_email') }}" required autocomplete="login_email" autofocus placeholder="Email / LRN / Username">

                @error('login_email')
                    <span class="invalid-feedback badge bg-danger mt-2 mb-2" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                @enderror

                <input id="login_password" type="password"
                    class="form-control @error('login_password') is-invalid @enderror" name="login_password" required
                ...
                <div class="password-toggle">
                    <input type="checkbox" id="togglePasswordConfirm">
                    <label for="togglePasswordConfirm">Show Password</label>
                </div>
    ...
    <script>
        ...
        const passwordConfirmInput = document.getElementById('login_password');
        ...
        togglePasswordConfirm.addEventListener('change', () => {
            passwordConfirmInput.type = togglePasswordConfirm.checked ? 'text' : 'password';
        });

        togglePasswords.addEventListener('change', () => {
            const newType = togglePasswords.checked ? 'text' : 'password';
