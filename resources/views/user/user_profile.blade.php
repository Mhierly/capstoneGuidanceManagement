                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                ...
                                <div class="mt-3">
                                    <h4 class="text-capitalize">{{ $student->firstname }} {{ $student->lastname }} <small
                                            class="text-secondary">{{ $student->school_id }}</small></h4>
                                    <p class="text-secondary mb-1"><span>{{ $current_grade }}</span> -
                                        <span>{{ $current_section }}</span></p>
                                    ...
                                    <p class="text-muted font-size-sm">
                                        @if ($student->house_no_street)
                                            {{ $student->house_no_street }}
                                        @else
                                            {{ '(UPDATE)' }}
                                        @endif, {{ $student_address['barangay'] }},
                                        {{ $student_address['city'] }}, {{ $student_address['province'] }}
                                    </p>
                            ...
                            <div class="d-flex">
                                <section class="w-50">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <p class="text-capitalize">{{ $student->firstname }}
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0 text-secondary">Emergency Contact</h6>
                                        </div>
                                        <div class="col-sm-9">
                ...
                <div class="modal-body">
                    <form id="edit_profile_form" class="row g-3" action="{{ route('student.profile.editor') }}"
                        ...
                        <div class="col-md-4 mb-2 text-center d-flex align-items-center">
                            <img src="{{ $profile_img }}" alt="Student Image" class="" width="110"
                                height="110" style="object-fit: cover;">
                            <input type="file" class="form-control" name="profile_img" id="profile_img">
                            <div id="file-error" class="text-danger mt-2" style="display:none;">Please select a valid
                        ...
                        <div class="d-flex">
                            <div class="col-md-3 me-2">
                                ...
                                <input type="text" class="form-control" id="profile_first_name"
                            ...
                            <div class="col-md-2 me-2">
                                ...
                                <input type="text" class="form-control" id="profile_suffix" name="profile_suffix"
                                    value="{{ $student->suffix }}" placeholder="(UPDATE)">
                            </div>
                        </div>
                        ...
                        <div class="d-flex">
                            <div class="col-md-5 me-3">
                                ...
                                <input type="date" class="form-control" id="profile_birthdate"
                        ...
                        <div class="d-flex">
                            <div class="col-md-6 me-3">
                                ...
                                <input type="email" class="form-control" id="profile_email" name="profile_email"
                                    value="{{ $student->email }}">
                                <small id="email-error" style="display:none; color:red;">Invalid email address.<span
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="text" class="form-control" id="profile_street" name="profile_street"
                                placeholder="(UPDATE)" value="{{ $student->house_no_street }}">
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <select id="profile_province" name="profile_province" class="form-control">
                                <option selected value="{{ $student->province }}">{{ $student_address['province'] }}
                                </option>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select id="profile_municipality" name="profile_municipality" class="form-control">
                                ...
                                <option selected value="{{ $student->municipality }}">{{ $student_address['city'] }}
                                </option>
                                <option disabled>Select</option>
                            </select>
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <select id="profile_baranggay" name="profile_baranggay" class="form-control">
                                ...
                                <option selected value="{{ $student->baranggay }}">{{ $student_address['barangay'] }}
                                </option>
                                <option disabled>Select</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="profile_father" name="profile_father"
                                placeholder="(UPDATE)" value="{{ $student->father }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="profile_father_occupation" class="form-label">Father Occupation</label>
                            <input type="text" class="form-control" id="profile_father_occupation"
                                name="profile_father_occupation" placeholder="(UPDATE)"
                                value="{{ $student->father_occupation }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="profile_mother" class="form-label">Mother Name</label>
                            <input type="text" class="form-control" id="profile_mother" name="profile_mother"
                                placeholder="(UPDATE)" value="{{ $student->mother }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="profile_mother_occupation" class="form-label">Mother Occupation</label>
                            <input type="text" class="form-control" id="profile_mother_occupation"
                                name="profile_mother_occupation" placeholder="(UPDATE)"
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select id="profile_living_with" name="living_with" class="form-control">
                                ...
                                <option value="Father" {{ $student->living_with == 'Father' ? 'selected' : '' }}>Father
                                </option>
                                <option value="Mother" {{ $student->living_with == 'Mother' ? 'selected' : '' }}>Mother
                                </option>
                                <option value="Other" {{ $student->living_with == 'Other' ? 'selected' : '' }}>Other
                                </option>
                            </select>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="profile_no_sibling" class="form-label">No. of Siblings</label>
                            <input type="number" class="form-control" id="profile_no_sibling" name="profile_no_sibling"
                                value="{{ $student->no_of_siblings }}" min="1">
                            </select>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="profile_sibling_position" class="form-label">Sibling Position</label>
                            <input type="number" class="form-control" id="profile_sibling_position"
                                name="profile_sibling_position" value="{{ $student->position }}" min="1"
                ...
                <div class="modal-body">
                    <form id="edit_profile2_form" class="row g-3"
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" id="lrn" class="form-control" name="lrn"
                                value="{{ $student->lrn }}" pattern="\d{12}" title="Please enter a 12-digit number"
                                maxlength="12" oninput="validateLRN(this)" placeholder="(Need to update)" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" min="50" max="100" id="gen_average" name="gen_average"
                                value="{{ $student->gen_average }}" class="form-control">
                        </div>
                        <div class="col-md-6">
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(provinces) {
                    ...
                    $.each(provinces, function(index, province) {
                        var selected = (province.province_code == student_province) ?
                            'selected' : '';
                        provinceDropdown.append('<option value="' + province.province_code +
                            '" ' + selected + '>' + province.province_description +
                            '</option>');
                    });
                },
        ...
        $(document).ready(function() {
            ...
            $('#current_grade_options').on('change', function() {
                ...
                $.ajax({
                    type: 'GET',
                    url: '{{ route('fetch.user.sections', ['grade_id' => ':grade_id']) }}'.replace(
                        ':grade_id', grade_id),
                    success: function(sections) {
                        ...
                        $.each(sections, function(index, section) {
                            current_section_options.append('<option value="' + section
                                .id + '">' + section.section_name + '</option>');
                        });
                    },
                    error: function(xhr, status, error) {
                        console.error(xhr.responseText);
        ...
        function getCities() {
            ...
            $.ajax({
                type: 'GET',
                url: '{{ route('fetch.user.location.cities', ':province_code') }}'.replace(':province_code', $(
                    '#profile_province').val()),
                success: function(cities) {
                    var cityDropdown = $('#profile_municipality');
                    cityDropdown.empty();

                    $.each(cities, function(index, city) {
                        var selected = (city.city_municipality_code ==
                            '{{ $student->municipality }}') ? 'selected' : '';
                        cityDropdown.append('<option value="' + city.city_municipality_code + '" ' +
                            selected + '>' + city.city_municipality_description + '</option>');
                    });
                },
                error: function(xhr, status, error) {
                    console.error(xhr.responseText);
            ...
            $.ajax({
                ...
                success: function(barangays) {
                    ...
                    $.each(barangays, function(index, barangay) {
                        var selected = (barangay.barangay_code == '{{ $student->baranggay }}') ?
                            'selected' : '';
                        barangayDropdown.append('<option value="' + barangay.barangay_code + '" ' +
                            selected + '>' + barangay.barangay_description + '</option>');
                    });
                },
                error: function(xhr, status, error) {
                    console.error(xhr.responseText);
